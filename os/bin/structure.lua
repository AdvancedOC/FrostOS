-- To update the /os_install file open FrostOS and probably run doas "structure / -i /.git -i /installers -i /to_install -i /tmp -i /mnt -i /os/etc/usertab -i /os/eeprom -i /os/eeprom_data > /os_toinstall" as administrator.
